...
(function() {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
templates['multisignature'] = template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  var buffer = "", stack1, functionType="function", self=this;
...
function program1(depth0,data) {
  ...
  buffer += "<label for=\"dataType\"></label>\n<select class=\"signature-select\" name=\"dataType\">\n";
  stack1 = helpers.each.call(depth0, depth0.typeModels, {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n</select>\n<div class=\"model-signatures\"></div>\n";
  return buffer;
  });
})();
...
(function() {
  var ContentTypeView, HeaderView, MainView, MultiSignatureView, OperationView, ParameterContentTypeView, ParameterView, ResourceView, ResponseContentTypeView, SignatureView, StatusCodeView, SwaggerUi, _ref, _ref1, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  ParameterView = (function(_super) {
    ...
    ParameterView.prototype.render = function() {
      var contentTypeModel, isParam, multisignatureModel, paramModel, parameterContentTypeView, responseContentTypeView, signatureModel, signatureView, template, type;
      ...
      if (paramModel && paramModel.subTypeModels && paramModel.subTypeModels.length) {
        ...
        signatureView = new MultiSignatureView({
          model: multisignatureModel,
          tagName: 'div'
        });
  ...
  SignatureView = (function(_super) {
    ...
    SignatureView.prototype.snippetToTextArea = function(e) {
      ...
      if (this.isParam) {
        ...
        textArea = $('.body-textarea', $(this.el).closest('.operation-params'));
  ...
  MultiSignatureView = (function(_super) {
    __extends(MultiSignatureView, _super);

    function MultiSignatureView() {
      _ref8 = MultiSignatureView.__super__.constructor.apply(this, arguments);
      return _ref8;
    }

    MultiSignatureView.prototype.events = {
      'change .signature-select': 'switchSignature'
    };

    MultiSignatureView.prototype.initialize = function() {
      return this.signatureElements = [];
    };

    MultiSignatureView.prototype.render = function() {
      var template, typeModel, _i, _len, _ref9;
      template = this.template();
      $(this.el).html(template(this.model));
      $('label[for=dataType]', $(this.el)).text('Type');
      _ref9 = this.model.typeModels;
      for (_i = 0, _len = _ref9.length; _i < _len; _i++) {
        typeModel = _ref9[_i];
        this.addTypeModel(typeModel);
      }
      this.switchSignature();
      return this;
    };

    MultiSignatureView.prototype.template = function() {
      return Handlebars.templates.multisignature;
    };

    MultiSignatureView.prototype.switchSignature = function(e) {
      var key, value, _ref9;
      if (e != null) {
        e.preventDefault();
      }
      _ref9 = this.signatureElements;
      for (key in _ref9) {
        if (!__hasProp.call(_ref9, key)) continue;
        value = _ref9[key];
        $(value).hide();
      }
      $(this.signatureElements[$('.signature-select', $(this.el)).val()]).show();
      return this;
    };

    MultiSignatureView.prototype.addTypeModel = function(typeModel) {
      var signatureModel, signatureView;
      signatureModel = {
        sampleJSON: JSON.stringify(typeModel.createJSONSample(), null, 2),
        isParam: this.model.isParam,
      ...
      this.signatureElements[typeModel.name] = signatureView.render().el;
      $('.model-signatures', $(this.el)).append(this.signatureElements[typeModel.name]);
      return this;
    };

    return MultiSignatureView;
